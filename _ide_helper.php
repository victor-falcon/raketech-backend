...
namespace Illuminate\Support\Facades {
     ...
     */        class Response {
         ...
         * @param mixed $options
         * @static 
         */        public static function jsonCollection($data, $status = 200, $headers = [], $options = 0)
        {
                        return \Illuminate\Routing\ResponseFactory::jsonCollection($data, $status, $headers, $options);
        }
            }
            /**
     * 
